...
<html lang="en">
<head>
  <title>Admin Booking Online</title>
...
<body>
  ...
  <div class="page-wrapper mini-sidebar show-sidebar" id="main-wrapper" data-layout="vertical" data-navbarbg="skin6" data-boxed-layout="full"
    ...
    <aside class="left-sidebar">
      <div>
        <div class="brand-logo d-flex align-items-center justify-content-between" style="background-color: #364d39;">
              ...
              <tr>
                ...
                <td width="50%" style="text-align: left; line-height: 15px; padding-left: 2px">
                  <label style="font-weight: bold; color: white; font-size: 19px; padding-top: 10px">Dashboard<label
                      style="color: #f9ca24; font-weight: bold;"> &nbsp Booking</label></label>
                </td>
              </tr>
            </table>
    ...
    <div class="body-wrapper">
      <header class="app-header" style="background-color: #364d39;">
                  ...
                  <a class="nav-link pe-0" href="javascript:void(0)" id="drop1" data-bs-toggle="dropdown"
                    ...
                    <div class="d-flex align-items-center">
                      <div class="user-profile-img">
                        <img src="<?php echo base_url('assets/user.png'); ?>" class="rounded-circle" width="35" height="35"
                          alt="">
                      </div>
                    </div>
                  </a>
                    ...
                    <div class="message-body">
                      <div class="py-8 px-7 mt-8 d-flex align-items-center">
                        <span class="d-flex align-items-center justify-content-center bg-light rounded-10">
                          <img src="<?php echo base_url('assets/user.png'); ?>" alt="" width="35" height="35">
                        </span>
