          ...
          <div class="col-xl-5 col-xxl-4">
            <div class="authentication-login min-vh-100 bg-body row justify-content-center align-items-center p-4">
              <div class="col-sm-8 col-md-6 col-xl-9">
                <center>
                  <img src="<?php echo base_url() ?>assets/logo_app.jpg" class="dark-logo rounded-circle" width="140px">
                  <br>
                  <br>
                  <h2 class="mb-3 fs-7 fw-bolder" style="font-weight: bold;">Sini Self Studio
                    Booking Online
                    <br>
                    <br>
                    <br>
